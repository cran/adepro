...
tone <- function(no1=0, no2=0, d=0.7) {
  t <- c(65.4064, 87.3071, 123.471, 164.814)
  if (no1==0) sound1 <- numeric(0) else sound1 <- sin(2*pi*t[no1]*seq(0, d, length.out=d*16000))
  if (no2==0) sound2 <- numeric(0) else sound2 <- sin(2*pi*t[no2]*seq(0, d, length.out=d*16000))
